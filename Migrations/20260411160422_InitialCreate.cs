    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "ResearchAreas",
                columns: new[] { "ResearchAreaId", "Description", "Name" },
                values: new object[,]
                {
                    { 1, "AI, ML, Deep Learning", "Artificial Intelligence" },
                    { 2, "ASP.NET, React, Angular", "Web Development" },
                    { 3, "Security, Encryption, Network Security", "Cybersecurity" },
                    { 4, "AWS, Azure, Cloud Architecture", "Cloud Computing" },
                    { 5, "iOS, Android, Flutter", "Mobile Development" }
                });
